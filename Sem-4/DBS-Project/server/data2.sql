...
INSERT INTO manager_login (manager_id, username, passwords) VALUES (DEFAULT, 'manager1', 'password1');
INSERT INTO manager_login (manager_id, username, passwords) VALUES (DEFAULT, 'manager2', 'password2');
INSERT INTO manager_login (manager_id, username, passwords) VALUES (DEFAULT, 'manager3', 'password3');
INSERT INTO manager_login (manager_id, username, passwords) VALUES (DEFAULT, 'manager4', 'password4');
INSERT INTO manager_login (manager_id, username, passwords) VALUES (DEFAULT, 'manager5', 'password5');
...
ALTER TABLE driver_info ADD CONSTRAINT driver_info_unique_constraint UNIQUE (driver_id, branch);
...
VALUES 
(5001, 'Ramesh Kumar', 'M', 9876543210, 123456789012, 'TS123456', 'HYDERABAD', '2020-01-15', 30000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES  
(5002, 'Suresh Patel', 'M', 9876543211, 234567890123, 'KA234567', 'BENGALURU', '2020-02-20', 31000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES 
(5003, 'Anita Singh', 'F', 9876543212, 345678901234, 'MH345678', 'MUMBAI', '2020-03-25', 32000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary)
VALUES
(5004, 'Vijay Sharma', 'M', 9876543213, 456789012345, 'DL456789', 'NEW DELHI', '2020-04-10', 33000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES 
(5005, 'Priya Reddy', 'F', 9876543214, 567890123456, 'TN567890', 'CHENNAI', '2020-05-15', 34000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES 
(5006, 'Amit Kumar', 'M', 9876543215, 678901234567, 'TS678901', 'HYDERABAD', '2020-06-20', 35000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES 
(5007, 'Suman Gupta', 'F', 9876543216, 789012345678, 'KA789012', 'BENGALURU', '2020-07-25', 36000); 
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES 
(5008, 'Rajesh Yadav', 'M', 9876543217, 890123456789, 'MH890123', 'MUMBAI', '2020-08-30', 37000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES  
(5009, 'Pooja Sharma', 'F', 9876543218, 901234567890, 'DL901234', 'NEW DELHI', '2020-09-05', 38000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES 
(5010, 'Sandeep Singh', 'M', 9876543219, 123412341237, 'TN123412', 'CHENNAI', '2020-10-10', 39000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES 
(5011, 'Meera Patel', 'F', 9876543220, 234123412341, 'TS234123', 'HYDERABAD', '2020-11-15', 40000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES 
(5012, 'Ajay Kumar', 'M', 9876543221, 341234123412, 'KA341234', 'BENGALURU', '2020-12-20', 41000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES  
(5013, 'Rani Verma', 'F', 9876543222, 412341234123, 'MH412341', 'MUMBAI', '2021-01-25', 42000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES 
(5014, 'Sunil Kumar', 'M', 9876543223, 123412341236, 'DL123412', 'NEW DELHI', '2021-02-28', 43000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES  
(5015, 'Neha Gupta', 'F', 9876543224, 234123412345, 'TN234123', 'CHENNAI', '2021-03-05', 44000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES 
(5016, 'Vivek Sharma', 'M', 9876543225, 341234123456, 'TS341234', 'HYDERABAD', '2021-04-10', 45000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES 
(5017, 'Divya Patel', 'F', 9876543226, 412341234567, 'KA412341', 'BENGALURU', '2021-05-15', 46000);
INSERT INTO driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary) 
VALUES 
(5018, 'Rajesh Singh', 'M', 9876543227, 123412341235, 'MH123412', 'MUMBAI', '2021-06-20', 47000); 
...
CREATE TABLE driver_status (
    ...
    FOREIGN KEY (driver_id,branch) REFERENCES driver_info(driver_id,branch) ON UPDATE CASCADE ON DELETE CASCADE,
...
INSERT INTO driver_status (driver_id, manager_id, branch, current_location, status) 
VALUES 
-- For HYDERABAD branch
(5001, 1000,'HYDERABAD', 'HYDERABAD', 'AVL'),
(5006, 1000,'HYDERABAD', 'HYDERABAD', 'AVL'),
(5011, 1000,'HYDERABAD', 'HYDERABAD', 'AVL'),
(5016, 1000,'HYDERABAD', 'HYDERABAD', 'AVL'),

-- For BENGALURU branch
(5002, 1001, 'BENGALURU', 'BENGALURU', 'AVL'),
(5007, 1001, 'BENGALURU', 'BENGALURU', 'AVL'),
(5012, 1001, 'BENGALURU', 'BENGALURU', 'AVL'),
(5017, 1001, 'BENGALURU', 'BENGALURU', 'AVL'),

-- For MUMBAI branch
(5003, 1002, 'MUMBAI', 'MUMBAI', 'AVL'),
(5008, 1002, 'MUMBAI', 'MUMBAI', 'AVL'),
(5013, 1002, 'MUMBAI', 'MUMBAI', 'AVL'),
(5018, 1002, 'MUMBAI', 'MUMBAI', 'AVL'),

-- For NEW DELHI branch
(5004, 1004, 'NEW DELHI', 'NEW DELHI', 'AVL'),
(5009, 1004, 'NEW DELHI', 'NEW DELHI', 'AVL'),
(5014, 1004, 'NEW DELHI', 'NEW DELHI', 'AVL'),

-- For CHENNAI branch
(5005, 1003, 'CHENNAI', 'CHENNAI', 'AVL'),
(5010, 1003, 'CHENNAI', 'CHENNAI', 'AVL'),
(5015, 1003, 'CHENNAI', 'CHENNAI', 'AVL');
...
ALTER TABLE vehicle_info ADD CONSTRAINT vehicle_info_unique_constraint UNIQUE (vehicle_id, branch);
...
CREATE TABLE vehicle_status (
    ...
    current_location VARCHAR(25) NOT NULL,
    status VARCHAR(25) NOT NULL CHECK (status IN ('BUSY', 'AVL')),
    FOREIGN KEY (vehicle_id,branch) REFERENCES vehicle_info(vehicle_id,branch) ON UPDATE CASCADE ON DELETE CASCADE,
    FOREIGN KEY (manager_id) REFERENCES manager_info(manager_id) ON UPDATE CASCADE ON DELETE SET NULL,
    FOREIGN KEY (current_location) REFERENCES city(city) ON UPDATE CASCADE ON DELETE CASCADE
);

-- Insert statements for vehicle_status table
INSERT INTO vehicle_status (vehicle_id, manager_id, branch, current_location, status) 
VALUES 
(2001, 1000, 'HYDERABAD', 'HYDERABAD', 'AVL'),
(2002, 1001, 'BENGALURU', 'BENGALURU', 'AVL'),
(2003, 1002, 'MUMBAI', 'MUMBAI', 'AVL'),
(2004, 1004, 'NEW DELHI', 'NEW DELHI', 'AVL'),
(2005, 1003, 'CHENNAI', 'CHENNAI', 'AVL'),
(2006, 1000, 'HYDERABAD', 'HYDERABAD', 'AVL'),
(2007, 1001, 'BENGALURU', 'BENGALURU','AVL'),
(2008, 1002, 'MUMBAI', 'MUMBAI', 'AVL'),
(2009, 1004, 'NEW DELHI', 'NEW DELHI', 'AVL'),
(2010, 1003, 'CHENNAI', 'CHENNAI', 'AVL'),
(2011, 1000, 'HYDERABAD', 'HYDERABAD', 'AVL'),
(2012, 1001, 'BENGALURU', 'BENGALURU', 'AVL'),
(2013, 1002, 'MUMBAI', 'MUMBAI', 'AVL'),
(2014, 1004, 'NEW DELHI', 'NEW DELHI', 'AVL'),
(2015, 1003, 'CHENNAI', 'CHENNAI', 'AVL');
...
CREATE OR REPLACE FUNCTION delete_old_assignment_on_assignment_delete()
RETURNS TRIGGER AS $$
BEGIN
    -- Archive the assignment in old_assignment table
    INSERT INTO old_assignment (assignment_id, vehicle_id, driver_id, route_id, start_date, return_date)
    VALUES (OLD.assignment_id, OLD.vehicle_id, OLD.driver_id, OLD.route_id, OLD.start_date, OLD.return_date);
    
    -- Update driver status to 'AVL' (Available) and set current_location to branch if the status is 'ACTIVE'
    IF OLD.status = 'ACTIVE' THEN
        UPDATE driver_status
        SET status = 'AVL', current_location = (SELECT branch FROM driver_info WHERE driver_id = OLD.driver_id)
        WHERE driver_id = OLD.driver_id;
    END IF;

    -- Update vehicle status to 'AVL' (Available) and set current_location to branch if the status is 'ACTIVE'
    IF OLD.status = 'ACTIVE' THEN
        UPDATE vehicle_status
        SET status = 'AVL', current_location = (SELECT branch FROM vehicle_info WHERE vehicle_id = OLD.vehicle_id)
...
-- Trigger function to delete assignments when a driver is deleted
CREATE OR REPLACE FUNCTION delete_assignment_on_driver_delete()
RETURNS TRIGGER AS $$
BEGIN
    -- Archive the deleted tuples into the old_assignment table
    INSERT INTO old_assignment (assignment_id, vehicle_id, driver_id, route_id, start_date, return_date)
    SELECT assignment_id, vehicle_id, driver_id, route_id, start_date, return_date
    FROM assignment
    WHERE driver_id = OLD.driver_id;

    -- Delete the tuples from the assignment table
    DELETE FROM assignment WHERE driver_id = OLD.driver_id;

    RETURN OLD;
END;
$$ LANGUAGE plpgsql;

-- Trigger function to delete assignments when a vehicle is deleted
CREATE OR REPLACE FUNCTION delete_assignment_on_vehicle_delete()
RETURNS TRIGGER AS $$
BEGIN
    -- Archive the deleted tuples into the old_assignment table
    INSERT INTO old_assignment (assignment_id, vehicle_id, driver_id, route_id, start_date, return_date)
    ...
    -- Delete the tuples from the assignment table
    DELETE FROM assignment WHERE vehicle_id = OLD.vehicle_id;

    RETURN OLD;
END;
$$ LANGUAGE plpgsql;

-- Trigger function to delete assignments when a route is deleted
CREATE OR REPLACE FUNCTION delete_assignment_on_route_delete()
RETURNS TRIGGER AS $$
BEGIN
    -- Archive the deleted tuples into the old_assignment table
    INSERT INTO old_assignment (assignment_id, vehicle_id, driver_id, route_id, start_date, return_date)
    ...
    -- Delete the tuples from the assignment table
    DELETE FROM assignment WHERE route_id = OLD.route_id;
...
-- Trigger to delete assignments when a driver is deleted
CREATE TRIGGER delete_assignment_on_driver_delete
AFTER DELETE ON driver_info
FOR EACH ROW
EXECUTE FUNCTION delete_assignment_on_driver_delete();

-- Trigger to delete assignments when a vehicle is deleted
CREATE TRIGGER delete_assignment_on_vehicle_delete
AFTER DELETE ON vehicle_info
FOR EACH ROW
EXECUTE FUNCTION delete_assignment_on_vehicle_delete();

-- Trigger to delete assignments when a route is deleted
CREATE TRIGGER delete_assignment_on_route_delete
AFTER DELETE ON route
FOR EACH ROW
EXECUTE FUNCTION delete_assignment_on_route_delete();

CREATE TRIGGER delete_old_assignment_on_assignment_delete
BEFORE DELETE ON assignment
FOR EACH ROW
EXECUTE FUNCTION delete_old_assignment_on_assignment_delete();



-- Trigger for vehicle_info table
CREATE OR REPLACE FUNCTION delete_vehicle_trigger()
RETURNS TRIGGER AS $$
BEGIN
    INSERT INTO old_vehicle_info (vehicle_id, license_plate, model, commissioned_on, mileage, branch, relieving_date)
    VALUES (OLD.vehicle_id, OLD.license_plate, OLD.model, OLD.commissioned_on, OLD.mileage, OLD.branch, current_date);
...
BEFORE DELETE ON vehicle_info
FOR EACH ROW
EXECUTE FUNCTION delete_vehicle_trigger();


-- Trigger for driver_info table
CREATE OR REPLACE FUNCTION delete_driver_trigger()
RETURNS TRIGGER AS $$
BEGIN
    INSERT INTO old_driver_info (driver_id, name, gender, contact, aadhaar, license, branch, joining_date, salary, relieving_date)
    VALUES (OLD.driver_id, OLD.name, OLD.gender, OLD.contact, OLD.aadhaar, OLD.license, OLD.branch, OLD.joining_date, OLD.salary, current_date);
...
BEFORE DELETE ON driver_info
FOR EACH ROW
EXECUTE FUNCTION delete_driver_trigger();


-- Trigger for manager_info table
CREATE OR REPLACE FUNCTION delete_manager_trigger()
RETURNS TRIGGER AS $$
BEGIN
    INSERT INTO old_manager_info (manager_id, name, gender, contact, aadhaar, email_id, branch, joining_date, salary, relieving_date)
    VALUES (OLD.manager_id, OLD.name, OLD.gender, OLD.contact, OLD.aadhaar, OLD.email_id, OLD.branch, OLD.joining_date, OLD.salary, current_date);
...
BEFORE DELETE ON manager_info
FOR EACH ROW
EXECUTE FUNCTION delete_manager_trigger();



-- Trigger function to update vehicle and driver status after inserting into the assignment table
CREATE OR REPLACE FUNCTION update_status_on_assignment_insert()
RETURNS TRIGGER AS $$
BEGIN
    -- Update vehicle status to 'BUSY' and set current_location to the destination of the new assignment
    UPDATE vehicle_status
    SET status = 'BUSY',
        current_location = (
...
-- Statement to execute the trigger function
CREATE TRIGGER update_status_on_assignment_insert
AFTER INSERT ON assignment
FOR EACH ROW
EXECUTE FUNCTION update_status_on_assignment_insert();


CREATE OR REPLACE FUNCTION update_status_on_manager_insert()
RETURNS TRIGGER AS $$
BEGIN
    UPDATE driver_status
...
CREATE TRIGGER update_status_on_manager_insert
AFTER INSERT ON manager_info
FOR EACH ROW
EXECUTE FUNCTION update_status_on_manager_insert();


-- Create or replace the trigger function
CREATE OR REPLACE FUNCTION update_assignment_status_on_return()
RETURNS TRIGGER AS $$
BEGIN
    -- Check if the return date is being set to a non-null value and greater than the start_date
    IF NEW.return_date IS NOT NULL AND NEW.return_date > OLD.start_date THEN
        -- Update driver_status table
        UPDATE driver_status
        SET current_location = (SELECT branch FROM driver_info WHERE driver_id = OLD.driver_id), status = 'AVL'
        WHERE driver_id = OLD.driver_id;

        -- Update vehicle_status table
        UPDATE vehicle_status
        SET current_location = (SELECT branch FROM vehicle_info WHERE vehicle_id = OLD.vehicle_id), status = 'AVL'
        WHERE vehicle_id = OLD.vehicle_id;
    END IF;
...
-- Rename the trigger to execute the updated function
ALTER TRIGGER update_status_on_assignment_return RENAME TO update_assignment_status_on_return;


-- Create the trigger to call the update_assignment_status_on_return function
CREATE TRIGGER trigger_update_assignment_status_on_return
BEFORE UPDATE ON assignment
FOR EACH ROW
EXECUTE FUNCTION update_assignment_status_on_return();
