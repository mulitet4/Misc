...
export default function Manager3() {
  ...
  const getData = async () => {
    try {
      ...
      const url = `http://localhost:4000/manager/getAllVehicle/${encodeURIComponent(
        managerEmail
      )}`;
      console.log(url);
      ...
      //   console.log(data);
      const vechiles = data.data.vehicle;
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className=" bg-black">license_plate</TableHead>
                  <TableHead className=" bg-black">model</TableHead>
                  <TableHead className=" bg-black">commissioned_on</TableHead>
                  <TableHead className=" bg-black">mileage</TableHead>
                ...
                {vehicles.map((item: any) => {
                  return (
                    <TableRow key={item.vehicle_id}>
                      ...
                      <TableCell>{item.commissioned_on}</TableCell>
