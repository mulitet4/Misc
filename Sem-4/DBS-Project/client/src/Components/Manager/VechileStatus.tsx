...
export default function VechileStatus() {
  ...
  const getData = async () => {
    try {
      ...
      const url = `http://localhost:4000/manager/getAllVehicleStatus/${encodeURIComponent(
        managerEmail
      )}`;
      console.log(url);
