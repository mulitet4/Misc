...
export default function InsuranceRecord() {
  ...
  const getData = async () => {
    try {
      ...
      const url = `http://localhost:4000/manager/getAllInsurance/${encodeURIComponent(
        managerEmail
      )}`;
      console.log(url);
      ...
      //   console.log(data);
      const insurances = data.data.insurance;
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-6">
          ...
          <div className="border shadow-sm rounded-lg">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className=" bg-black">policy_id</TableHead>
                  <TableHead className=" bg-black">vehicle_id</TableHead>
                  <TableHead className=" bg-black">policy_number</TableHead>
